...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAlreadyExistsException(AlreadyExistsException alreadyExistsException) {
        return ResponseEntity
                .status(alreadyExistsException.getErrorCode().getHttpStatus())
                .body(ErrorResponse.of(alreadyExistsException.getErrorCode(), alreadyExistsException.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleUserNotEligibleException(
        ...
        return ResponseEntity
                ...
                .body(ErrorResponse.of(userNotEligibleException.getErrorCode(), userNotEligibleException.getMessage()));
    }
